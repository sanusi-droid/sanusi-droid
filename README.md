...
# Ali Sanusi Cybersecurity Analyst

👋 Hello! I’m **Ali Sanusi**, a results-driven Cybersecurity Analyst with two years of experience protecting cloud and on-prem infrastructures. My work focuses on threat detection, vulnerability management, and continuous security monitoring. This repository gathers the lab projects and reference guides that demonstrate my technical depth and commitment to secure-by-design principles.
...
| 06-penetration-testing | Network and web-app pentest with Nmap | [View Repo](#) |
| 07-risk-assessment | CIA impact mapping and risk matrix | [View Repo](#) |
| 08-mitre-threat-hunt | ATT&CK-aligned threat hunting scripts | [View Repo](#) |
| 09-Event Management | ATT&CK-aligned event management using SPLUNK (spl) | [View Repo](https://github.com/sanusi-droid/Event-Managemen) |
...
| 12-Threat-Modeling | Threat Dragon and Windows Threat Modeling Tool | [View Repo](#) |
